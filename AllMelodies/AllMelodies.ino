/* 
  Super Mario & Zelda Themes Merged
  Connect a piezo buzzer or speaker to pin 10.
  Based on melodies from: https://github.com/robsoncouto/arduino-songs
*/
...
int notesJoy = sizeof(melodyJoy) / sizeof(melodyJoy[0]) / 2;
...
int notesStorms = sizeof(melodyStorms) / sizeof(melodyStorms[0]) / 2;
